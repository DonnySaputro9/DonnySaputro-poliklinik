...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="<?php echo e(route('pembelian.tambahBarangStore')); ?>" method="POST" class="form-horizontal form-label-left">
            <?php echo csrf_field(); ?>
                <div class="form-group">
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="hidden" class="form-control" id="id_kodePembelian" name="id_kodePembelian" required value="<?php echo e(old('id_kodePembelian', $kodePembelian->id)); ?>">
                        <input type="hidden" class="form-control" id="tanggal" name="tanggal" required value="<?php echo e(old('tanggal', $pembelian->tanggal)); ?>">
                        <input type="hidden" class="form-control" id="id_suplier" name="id_suplier" required value="<?php echo e(old('id_suplier', $suplier->id)); ?>">
                    </div>
                </div>
                <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" id="harga_barang" name="harga_barang" required value="<?php echo e(old('harga_barang')); ?>" placeholder="Harga">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                        ...
                        <a type="button" href="" class="btn btn-primary">Batal</a>
                    </div>
                </div>
            </form>
        ...
        $(document).ready(function() {
            ...
            $('#id_barang').change(function(){
                ...
                $.get( url, function( data ) {
                    ...
                    console.log(data.satuan.nama_satuan);
                });
            })
            ...
            $('#jumlah_barang').keyup(function(){
                ...
                $.get( url, function( data ) {
                    var sub_total = jumlah_barang * parseInt(data.harga_beli);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK\project\OrangeGrowTogether\resources\views/transaksi/pembelian/tambahBarang.blade.php ENDPATH**/ ?>