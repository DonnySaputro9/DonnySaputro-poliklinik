    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Form -->
                    <form action="<?php echo e(route('editperiksa.update', ['id' => $daftarPoli->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama"
                                value="<?php echo e($daftarPoli->pasien->nama); ?>" required disabled>
                            <input type="hidden" class="form-control" id="id" name="id_daftar_poli"
                                value="<?php echo e($daftarPoli->id); ?>">
                        </div>
                            ...
                            <select class="form-control" id="obatSelect" required>
                                ...
                                <?php $__currentLoopData = $obats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($obat->id); ?>" data-harga="<?php echo e($obat->harga); ?>">
                                        <?php echo e($obat->nama_obat); ?></option>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\joki\capstone_poliklinik\aplikasi-poli\resources\views/dokter/edit-periksa.blade.php ENDPATH**/ ?>