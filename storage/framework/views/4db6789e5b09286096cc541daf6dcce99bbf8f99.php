...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo e(asset('OnePage/assets/img/favicon.png')); ?>" rel="icon">
    <link href="<?php echo e(asset('OnePage/assets/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">
    ...
    <!-- Vendor CSS Files -->
    <link href="<?php echo e(asset('OnePage/assets/vendor/aos/aos.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('OnePage/assets/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('OnePage/assets/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('OnePage/assets/vendor/boxicons/css/boxicons.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('OnePage/assets/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('OnePage/assets/vendor/remixicon/remixicon.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('OnePage/assets/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="<?php echo e(asset('OnePage/assets/css/style.css')); ?>" rel="stylesheet">
...
<body>
            ...
            <div class="row icon-boxes">
                <div class="col-md-5 col-lg-6 d-flex align-items-center mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="<?php echo e(route('pasien.login')); ?>">Login Sebagai Pasien</a></h4>
                ...
                <div class="col-md-5 col-lg-6 d-flex align-items-center mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        <div class="icon"><i class="ri-user-line"></i></div>
                        <h4 class="title"><a href="<?php echo e(route('dokter.dashboard')); ?>">Login Sebagai Dokter</a></h4>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="<?php echo e(asset('OnePage/assets/img/testimonials/testimonials-1.jpg')); ?>"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="<?php echo e(asset('OnePage/assets/img/testimonials/testimonials-2.jpg')); ?>"
                                    class="testimonial-img" alt="">
                                <h3>Larissa Putri</h3>
                                <h4>Jakarta</h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="<?php echo e(asset('OnePage/assets/img/testimonials/testimonials-4.jpg')); ?>"
                                    class="testimonial-img" alt="">
    ...
    <!-- Vendor JS Files -->
    <script src="<?php echo e(asset('OnePage/assets/vendor/purecounter/purecounter_vanilla.js')); ?>"></script>
    <script src="<?php echo e(asset('OnePage/assets/vendor/aos/aos.js')); ?>"></script>
    <script src="<?php echo e(asset('OnePage/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('OnePage/assets/vendor/glightbox/js/glightbox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('OnePage/assets/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>
    <script src="<?php echo e(asset('OnePage/assets/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('OnePage/assets/vendor/php-email-form/validate.js')); ?>"></script>

    <!-- Template Main JS File -->
    <script src="<?php echo e(asset('OnePage/assets/js/main.js')); ?>"></script>

</body>

</html>
<?php /**PATH D:\KULIAH\joki\capstone_poliklinik\aplikasi-poli\resources\views/index.blade.php ENDPATH**/ ?>