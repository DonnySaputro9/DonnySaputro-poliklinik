...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('template-admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')); ?>">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset('template-admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css')); ?>">
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?php echo e(asset('template-admin/plugins/jqvmap/jqvmap.min.css')); ?>">
    <!-- Theme style -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo e(asset('template-admin/plugins/summernote/summernote-bs4.min.css')); ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha512-...", crossorigin="anonymous" />


    <link rel="stylesheet"
        href="<?php echo e(asset('template-admin/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(asset('template-admin/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(asset('template-admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')); ?>">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo e(asset('template-admin/dist/img/AdminLTELogo.png')); ?>"
    ...
    <!-- Sparkline -->
    <script src="<?php echo e(asset('template-admin/plugins/sparklines/sparkline.js')); ?>"></script>
    <!-- JQVMap -->
    <script src="<?php echo e(asset('template-admin/plugins/jqvmap/jquery.vmap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('template-admin/plugins/jqvmap/maps/jquery.vmap.usa.js')); ?>"></script>
    <!-- jQuery Knob Chart -->
    <script src="<?php echo e(asset('template-admin/plugins/jquery-knob/jquery.knob.min.js')); ?>"></script>
    <!-- daterangepicker -->
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="<?php echo e(asset('template-admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')); ?>">
    </script>
    <!-- Summernote -->
    <script src="<?php echo e(asset('template-admin/plugins/summernote/summernote-bs4.min.js')); ?>"></script>
    <!-- overlayScrollbars -->
...
<?php /**PATH D:\KULIAH\joki\capstone_poliklinik\aplikasi-poli\resources\views/layouts/main.blade.php ENDPATH**/ ?>