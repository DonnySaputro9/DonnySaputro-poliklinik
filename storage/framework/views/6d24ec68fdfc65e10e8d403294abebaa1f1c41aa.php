...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <a type="button" class="btn btn-success" href="<?php echo e(route('penjualan.nota', $penjualan->id)); ?>" style="margin-bottom: 20px; right: 3%; position: absolute;"><p style="margin: 0; font-size: 12px;">Cetak Nota</p></a>
            ...
            <a type="button" class="btn btn-primary" href="<?php echo e(route('penjualan.index')); ?>" style="margin-bottom: 20px;"><p style="margin: 0; font-size: 12px;">Kembali</p></a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK\project\OrangeGrowTogether\resources\views/transaksi/penjualan/detail.blade.php ENDPATH**/ ?>