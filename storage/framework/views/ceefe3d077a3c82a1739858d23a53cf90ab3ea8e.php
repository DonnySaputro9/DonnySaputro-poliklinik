...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form action="<?php echo e(route('data-barang.update', $barang->id)); ?>" method="POST" class="form-horizontal form-label-left">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="id_kategori" name="id_kategori" required>
                            <?php if($barang->id_kategori): ?>
                                <option disabled>Pilih Kategori</option>
                                <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($k->id); ?>" <?php echo e($k->id == $barang->id_kategori ? 'selected' : ''); ?>><?php echo e($k->nama_kategori); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="id_satuan" name="id_satuan" required>
                            <?php if($barang->id_satuan): ?>
                                ...
                                <?php $__currentLoopData = $satuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>" <?php echo e($s->id == $barang->id_satuan ? 'selected' : ''); ?>><?php echo e($s->nama_satuan); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>" id="nama_barang" name="nama_barang" required value="<?php echo e(old('nama_barang', $barang->nama_barang)); ?>" placeholder="Nama Barang">
...
unset($__errorArgs, $__bag); ?>" id="harga_beli" name="harga_beli" required value="<?php echo e(old('harga_beli', $barang->harga_beli)); ?>" placeholder="Harga Beli">
...
unset($__errorArgs, $__bag); ?>" id="harga_grosir" name="harga_grosir" required value="<?php echo e(old('harga_grosir', $barang->harga_grosir)); ?>" placeholder="Harga Grosir">
...
unset($__errorArgs, $__bag); ?>" id="harga_ecer" name="harga_ecer" required value="<?php echo e(old('harga_ecer', $barang->harga_ecer)); ?>" placeholder="Harga Eceran">
...
unset($__errorArgs, $__bag); ?>" id="stok" name="stok" required value="<?php echo e(old('stok', $barang->stok)); ?>" placeholder="Stok">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                        ...
                        <a type="button" href="<?php echo e(route('data-barang.index')); ?>" class="btn btn-primary">Cancel</a>
                    </div>
                </div>
            </form>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WORK\project\OrangeGrowTogether\resources\views/barang/edit.blade.php ENDPATH**/ ?>