                ...
                <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
                    ...
                    <?php echo csrf_field(); ?>  
                        ...
                        <div class="wrap-input100 validate-input m-b-12" data-validate = "Nama Pengguna is required">
                            <input type="text" name="nama_lengkap" class="input100" id="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required>
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100 validate-input m-b-12" data-validate = "Alamat is required">
                            <input type="text" name="alamat" class="input100" id="alamat" placeholder="Alamat" value="<?php echo e(old('alamat')); ?>" required>
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100 validate-input m-b-12" data-validate = "No Hp is required">
                            <input type="number" name="no_hp" class="input100" id="no_hp" placeholder="No Hp" value="<?php echo e(old('no_hp')); ?>" required>
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100 validate-input m-b-12" data-validate = "No Ktp is required">
                            <input type="number" name="no_ktp" class="input100" id="no_ktp" placeholder="No Ktp" value="<?php echo e(old('no_ktp')); ?>" required>
                            <span class="focus-input100"></span>
                        </div>
...
</html><?php /**PATH D:\project-laravel\ZZZZZZZZZZZZZZZZZZZZ\OrangeGrowTogether\resources\views/register/index.blade.php ENDPATH**/ ?>